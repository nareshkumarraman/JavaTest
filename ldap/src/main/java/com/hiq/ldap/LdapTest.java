...
public class LdapTest {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapAccountToLookup = "cn=admin,dc=abacus";
    ...
    public SearchResult findAccountByAccountName(DirContext ctx, String ldapSearchBase, String accountName) throws NamingException {
        ...
        String searchFilter = "(&(objectClass=simpleSecurityObject)(sAMAccountName=" + accountName + "))";

        SearchControls searchControls = new SearchControls();
        searchControls.setSearchScope(SearchControls.SUBTREE_SCOPE);

//        NamingEnumeration<SearchResult> results = ctx.search(ldapSearchBase,searchFilter, searchControls);
        NamingEnumeration<SearchResult> results = ctx.search(ldapSearchBase,"(objectclass=simpleSecurityObject)", searchControls);
